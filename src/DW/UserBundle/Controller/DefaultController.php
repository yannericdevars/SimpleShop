    ...
    public function loginAction(Request $request)
    {
        ...
        if ($request->isMethod('POST')) 
        {
            ...
            if (is_object($user_log))
            {
                    ...
                    $user_name = $user_log->getUsername();
                    $user_roles = $this->getRequest()->getSession()->get('userAutentif');
        ...
        //var_dump($user_roles); die;
         return $this->render('DWUserBundle:Default:login.html.twig', array(
                'form' => $form->createView(), 'user_name' => $user_name, 'user_roles' => $user_roles, 'gest_site' => $gest_site
            ));     
    }   
