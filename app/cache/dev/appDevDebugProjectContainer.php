...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/Resources');
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager512ee391ceb64_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager512ee391ceb64_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/jms_diextra/doctrine/EntityManager_512ee391ceb64.php';

        $a = $this->get('annotation_reader');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_741794a0a4634a091509c18499d83612');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_741794a0a4634a091509c18499d83612');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_741794a0a4634a091509c18499d83612');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/src/DW/UserBundle/Entity', 1 => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/src/DW/SlideShowBundle/Entity'));
        ...
        $g->setProxyDir('/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager512ee391ceb64_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($h, $this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'a47e31018e6a9f2477e11797b52c4b3810');
    }
    ...
    /**
     * Gets the 'itemservice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return DW\SlideShowBundle\Service\ItemService A DW\SlideShowBundle\Service\ItemService instance.
     */
    protected function getItemserviceService()
    {
        return $this->services['itemservice'] = new \DW\SlideShowBundle\Service\ItemService();
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/logs/dev.log', 100, true);
    }
    ...
    /**
     * Gets the 'passwordutilities' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return DW\UserBundle\Service\PasswordUtilities A DW\UserBundle\Service\PasswordUtilities instance.
     */
    protected function getPasswordutilitiesService()
    {
        return $this->services['passwordutilities'] = new \DW\UserBundle\Service\PasswordUtilities('passwordUtilities');
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/sessions');
    }
    ...
    protected function getSwiftmailer_TransportService()
    {
        ...
        $instance->setUsername('user@gmail.com');
        $instance->setPassword('xxxx');
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Applications/MAMP/htdocs/SimpleShop/SimpleShop/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
     ...
     * This method always returns the same instance of the service.
     *
     * @return DW\UserBundle\Service\UserService A DW\UserBundle\Service\UserService instance.
     */
    protected function getUserserviceService()
    {
        return $this->services['userservice'] = new \DW\UserBundle\Service\UserService('getList');
    }
     ...
     *
     * @return EntityManager512ee391ceb64_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev',
            'kernel.logs_dir' => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/logs',
            ...
            'locale' => 'en',
            'secret' => 'a47e31018e6a9f2477e11797b52c4b3810',
            'database_path' => NULL,
            'email_sender' => 'moncompte@gmail.com',
            'cache_home_page' => 5,
            ...
            'debug.container.dump' => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\TraceableControllerResolver',
            'kernel.secret' => 'a47e31018e6a9f2477e11797b52c4b3810',
            ...
            'session.save_path' => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/profiler',
            ...
            'router.resource' => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.transport.smtp.username' => 'user@gmail.com',
            'swiftmailer.transport.smtp.password' => 'xxxx',
            ...
            'assetic.cache_dir' => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/../web',
            'assetic.write_to' => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/jms_diextra/doctrine/EntityManager_512ee391ceb64.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager512ee391ceb64_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/Applications/MAMP/htdocs/SimpleShop/SimpleShop/app/cache/dev/jms_security',
